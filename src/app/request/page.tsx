                        ...
                        <tr key={req.id} className="border-b border-gray-50 hover:bg-sky-50/50">
                          ...
                          <td className="py-3 text-right pr-4">
                            <div className="flex justify-end gap-2">
                              ...
                              <button onClick={() => { setPrintingRequest(req); setTimeout(handlePrintPastRequest, 100); }} className="p-2 bg-sky-50 text-sky-500 rounded-lg hover:bg-sky-100" title="列印申請單"><Printer className="w-4 h-4" /></button>
                            </div>
                          </td>
                        </tr>
                      ))}
